...
public class PpLeaveTest {
    ...
    public void prepare() {
        ...
        Deployment deployment = repositoryService.createDeployment()//创建一个部署对象
                .name("请假审批")
                .addClasspathResource("rule/product.drl")
                .addClasspathResource("processes/ppleave.bpmn")
                .addClasspathResource("processes/ppleave.png")
                .deploy();
    ...
    public void start() {
        ...
        String processDefinitionKey ="ppleave";//每一个流程有对应的一个key这个是某一个流程内固定的写在bpmn内的
